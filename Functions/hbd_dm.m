function H_tot = hbd_dm(N_sites,N_up,N_down,t_up,t_down,epsilon_up,epsilon_down,U,kappa,Em)
...
t_up(2:2:N_sites-2)=t_up(2:2:N_sites-2)*exp(-1i*kappa);
t_up(N_sites)=t_up(N_sites)*exp(1i*kappa);
t_down(2:2:N_sites-2)=t_down(2:2:N_sites-2)*exp(-1i*kappa);
